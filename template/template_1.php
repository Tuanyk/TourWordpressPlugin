...
<style>
	...
	#leo_images > div:nth-child(n+7) {display: none;}
	...
	@media (max-width: 767px)
	{
		...
		#leo_images > div:nth-child(2), #leo_images > div:nth-child(3), #leo_images > div:nth-child(4), #leo_images > div:nth-child(5), #leo_images > div:nth-child(6) {
			grid-row-end: span 2;
	...
	@media (min-width:768px) {
		...
		#leo_images > div:nth-child(2), #leo_images > div:nth-child(5), #leo_images > div:nth-child(6) {
			grid-row-end: span 2;
			grid-column-end: span 2;
		}

		#leo_images > div:nth-child(2) > div, #leo_images > div:nth-child(5) > div, #leo_images > div:nth-child(6) > div {
			overflow: hidden;
			padding-block-start: 100%;
			position: relative;
		}
		#leo_images > div:nth-child(3), #leo_images > div:nth-child(4) {
			grid-row-end: span 2;
		}

		#leo_images > div:nth-child(3) > div, #leo_images > div:nth-child(4) > div {
			overflow: hidden;
			padding-block-start: 100%;
			position: relative;
    ...
    @media only screen and (max-width: 767px) {
        #service_box {grid-template-columns: 1fr; gap: 10px;}
        #service_box .icon_box {margin: 0.2em 0;}
        #service_box .box {padding: 10px 10px;}
    }
    ...
    #price-table {font-weight:700; font-size: 18px; width:100%;}
    #price-table tr:nth-child(1) td {
        background:#CC3333 !important; color: #fff;
    }
    ...
    #price-table {font-weight:700; font-size: 16px; width:100%;}
    }
    #faq {
    width: 100%;
    }
    #faq div:not(.faq-answer) { display: block;}
    .faq-answer {
    display: none;
    font-size: 17px;
    line-height: 2;
...
<section id="leo_images">
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_1') ); ?>"/></div></div>
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_2') ); ?>"/></div></div>
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_3') ); ?>"/></div></div>
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_4') ); ?>"/></div></div>
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_5') ); ?>"/></div></div>
    <div><div><img src="<?= wp_get_attachment_url( leo_field('leo_slide_image_6') ); ?>"/></div></div>
</section>
...
<div class="main-content">
    <div class="content left">
        ...
        foreach ($tour_faq as $faq) { ?>
            <div class="faq-item">
                <div class="faq-question"><h2><?= $faq['question']; ?><i class="arrow down"></i></h2></div>
